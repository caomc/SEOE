...
#word2vec model
sentences = gensim.models.word2vec.LineSentence('../data/greedy/q2_greedy_document.seq')
model = gensim.models.Word2Vec(sentences, hs=1,min_count=1,window=2,size=40)
model.save('../data/greedy/q2_greedy_model.model')
...
with open('../data/greedy/q2_greedy_words.vec', 'a') as word_vec_file:
