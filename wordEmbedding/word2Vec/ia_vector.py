...
#word2vec model
sentences = gensim.models.word2vec.LineSentence('../data/ia/q2_ia_document.seq')
model = gensim.models.Word2Vec(sentences, hs=1,min_count=1,window=2,size=40)
model.save('../data/ia/q2_ia_model.model')
...
with open('../data/ia/q2_ia_words.vec', 'a') as word_vec_file:
