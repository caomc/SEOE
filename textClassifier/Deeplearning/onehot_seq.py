...
# 超参数
embed_size = 159 # how big is each word vector
...
def embedding_onehot():
    print('running embedding_onehot......')
    # 存储所有 word_index 中所有向量的数组，留意其中多一位，词向量全为 0， 用于 padding
    embedding_matrix = np.zeros((len(word_index) + 1, 159))
...
embedding_matrix = embedding_onehot()
...
# pred_val_y2, pred_test_y2, pred_train_y2, access_result = train_pred(model_lstm_gru(embedding_matrix), epochs=40)
# plot_result(access_result)
# threshold = 0.25
# y_true = Y_true
